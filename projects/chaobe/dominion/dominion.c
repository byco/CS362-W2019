...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    switch( card )
    {
        ...
        case adventurer:
            ...
            adventurer_function(currentPlayer, drawntreasure, cardDrawn, temphand,  state, handPos, choice1);
        ...
        case feast:
            feast_function(currentPlayer, drawntreasure, cardDrawn, temphand,  state, handPos, choice1);
        ...
        case smithy:
            ...
            smithy_function(currentPlayer, drawntreasure, cardDrawn, temphand,  state, handPos, choice1);
        ...
        // REFACTORED - GREAT HALL NOW A SEPARATE FUNCTION
        case great_hall:
            great_hall_function(currentPlayer, drawntreasure, cardDrawn, temphand,  state, handPos, choice1);
        ...
        case sea_hag:
            ...
            sea_hag_function(currentPlayer, drawntreasure, cardDrawn, temphand,  state, handPos, choice1);
...
int adventurer_function(int currentPlayer, int drawntreasure, int cardDrawn, int temphand[MAX_HAND], struct gameState *state, int handPos, int choice1)
{
    ...
    // NOTE: I had to change this back to 0 for assignment 4, since I suspect it might be causing errors in my program.
    return 0;
}
